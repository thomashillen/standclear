    ...
    import("mapbox-gl").then((mapboxgl) => {
      ...
      map.on("load", () => {
        ...
        map.on("click", "subway-trains-icon", (e: unknown) => {
          ...
          const line = routeId ? lines[routeId] : undefined;
        ...
        map.on("click", "subway-stops-hit", (e: unknown) => {
          ...
          // station dot; without this guard, both handlers could open
          // different nearby complexes. Let the route-aware train handler
          // choose the station associated with the marker instead.
          if (ev.point) {
