...
const ENTRIES: Entry[] = [
  {
    ...
    changes: [
      ...
      { type: "added", text: "Per-page Open Graph cards for /about, /pricing, /changelog, /press, /status, and every /line/[id] so a tweeted page link gets a card framed for that surface instead of the generic site card." },
