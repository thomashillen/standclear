...
const ENTRIES: Entry[] = [
  {
    ...
    changes: [
      ...
      { type: "added", text: "Per-page Open Graph cards for /about, /pricing, /changelog, /privacy, /terms, and every /line/[id] so a tweeted line link gets a custom card with the route bullet, line name, and from/to terminals — instead of the generic site card." },
